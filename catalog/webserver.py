...
import cgi
from database_setup import Base, Genre, Subgenre
from sqlalchemy import create_engine
from sqlalchemy.orm import sessionmaker

engine = create_engine('sqlite:///musicgenre.db')
        ...
        try:
            ...
            if self.path.endswith("/delete"):
                ...
                if myGenreQuery:
                    ...
                    output = ""
                    output += "<html><body>"
                    output += "<h1>Are you sure you want to delete %s?" % myGenreQuery.name
                    output += "<form method='POST' enctype = 'multipart/form-data' action = '/genres/%s/delete'>" % genreIDPath
